...
module.exports = app => {
  ...
  const Goods = app.model.define(TableNames.GOODS, {
    goods_id: {
      type: BIGINT,
      primaryKey: true,
      autoIncrement: true,
  ...
  Goods.associate = () => {
    app.model.Goods.belongsTo(app.model.SysUser, { foreignKey: 'create_user_id', as: 'creator' });
    app.model.Goods.belongsTo(app.model.SysUser, { foreignKey: 'update_user_id', as: 'updater' });
    app.model.Goods.belongsTo(app.model.GoodsCategory, { foreignKey: 'category_id', as: 'category' });
  };
